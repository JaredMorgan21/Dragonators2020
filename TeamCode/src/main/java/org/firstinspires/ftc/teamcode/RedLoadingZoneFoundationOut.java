...
@Autonomous(name = "Red Loading Zone Foundation Out", group =  "red full")


public class RedLoadingZoneFoundationOut extends LinearOpMode {
//declaring motor variables, BLM = Back left motor 
    ...
    public void runOpMode() {
        ...
        //this drops the intake
            ...
            flywheelL.setPower(0);
            flywheelR.setPower(0);
            //we line up with the foundation to pull it
            drive(-0.25, 200);
            GyroTurn(0.25, 25);
            drive(0.25, 350);
            sleep(500);

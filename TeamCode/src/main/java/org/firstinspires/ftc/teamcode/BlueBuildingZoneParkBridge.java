...
@Autonomous(name = "Blue building zone Park Bridge", group =  "blue full")


public class BlueBuildingZoneParkBridge extends LinearOpMode {
//declaring motor variables, BLM = Back left motor 
    ...
    public double getAngle(){
      ...
      public void encoderDrive (double power, int inches){
       ...
       /*public void GyroStrafe(int power, int time){
        double currentAng=0;
        resetAngle();
        runtime.reset();
